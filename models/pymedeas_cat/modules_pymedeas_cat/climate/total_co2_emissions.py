...
@component.add(
    name="biofuels sensitivity factor",
    units="Dmnl",
    comp_type="Constant",
    comp_subtype="Normal",
)
def biofuels_sensitivity_factor():
    return 0
...
@component.add(
    name="historic GtCO2 per EJ waste",
    comp_type="Constant",
    comp_subtype="External",
