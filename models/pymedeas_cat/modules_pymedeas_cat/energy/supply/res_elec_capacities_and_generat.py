...
@component.add(
    name="Installed capacity RES elec delayed",
    units="TW",
    subscripts=["RES elec"],
    comp_type="Stateful",
...
@component.add(
    name="potential tot generation after curtailment RES elec TWh",
    units="TWh/year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
@component.add(
    name="renewable sensitivity factor",
    units="Dmnl",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="replaced capacity RES elec TW",
    units="TW",
    subscripts=["RES elec"],
    comp_type="Stateful",
    comp_subtype="Integ",
