...
def activate_bottom_up_method():
    ...
    value.loc[["Transport storage and communication"]] = if_then_else(
...
@component.add(
    name="EI sensitivity factor",
    units="Dmnl",
    comp_type="Constant",
    comp_subtype="Normal",
)
def ei_sensitivity_factor():
    return 1.1
...
@component.add(
    ...
    comp_subtype="Normal",
    depends_on={
        "energy_intensity_target_mdollar": 1,
        "mdollar_per_tdollar": 1,
        "ei_sensitivity_factor": 1,
    },
)
def energy_intensity_target():
    ...
    """
    return (
        energy_intensity_target_mdollar()
        * mdollar_per_tdollar()
        * ei_sensitivity_factor()
    )
